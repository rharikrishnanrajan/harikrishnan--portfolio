...
export const personal: PersonalInfo = {
  ...
  tagline: 'Building reliable systems. Automating what comes next.',
  description:
    'Results-driven DevOps Engineer and MCA student with hands-on experience in designing and implementing CI/CD pipelines, containerization, and cloud infrastructure on AWS. Proficient in Docker, Jenkins, Linux, SonarQube, Git, and GitHub, with a strong foundation built through project work and certified training at L&T EduTech. Also experienced in building AI-powered applications, including a Flutter-based chatbot integrated with the Gemini AI API. Passionate about automating software delivery processes and leveraging modern AI tools to improve speed, reliability, and security.',
  location: 'Coimbatore, India',
  email: 'rharikrishnanrajan@gmail.com',
  phone: '+91 93677 57607',
  github: 'https://github.com/rharikrishnanrajan',
  linkedin: 'https://www.linkedin.com/in/rharikrishnanrajan',
};

export const focusAreas = [
  'Cloud Infrastructure (AWS EC2, ECS, ECR, Route 53)',
  'CI/CD Pipeline Automation (Jenkinsfile & DevSecOps)',
  'Containerization & Clustering (Docker & Swarm)',
  'Security, Scanning & Quality (Trivy & SonarQube)',
...
export const seedProjects: Project[] = [
  ...
  },
  {
    ...
    metric: 'Conversational Generative AI Integration',
    architectureType: 'Mobile Client & Gemini API Architecture',
...
// Note: As requested, Frontend, Backend, Database & Cloud, and Programming categories have been removed.
// Focus is solely on DevOps, Cloud, Containers, CI/CD, Security, OS, and AI automation.
